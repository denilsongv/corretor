...
def conectar_google_sheets():
    ...
    try:
        ...
        # Tenta carregar do secrets (Streamlit Cloud) primeiro
        try:
            import json
            ...
            # Se falhar, tenta arquivo local (desenvolvimento)
            try:
                creds = ServiceAccountCredentials.from_json_keyfile_name("credentials.json", scope)
                client = gspread.authorize(creds)
                return client
            except:
                raise Exception("Não foi possível conectar: " + str(e))
